...
export const NewPostPopup: React.FC<Props> = ({
  setAddPostModal,
  authData,
  newPostRef,
}) => {
        ...
        <div className="">
          ...
          <form className="mt-3 flex flex-col h-full" onSubmit={handleSubmit}>
            ...
            <input
              ...
              required
            />
            <div className="mt-2 px-1 py-1 bg-green-500 text-center rounded-sm font-normal">
              Supports Markdown!{" "}
              <a
                rel="noreferrer"
                target="_blank"
            ...
            <textarea
              className="mt-2 placeholder-gray-700 ring-1  ring-black focus:ring-2 focus:outline-none px-1 py-1 rounded-sm overflow-y-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100"
            ...
            {content !== "" ? (
              <div>
                ...
                <div className="mt-2  ring-1  ring-black px-1 py-1 rounded-sm">
                  <ReactMarkdown
                    children={content}
                    className="prose prose-blue md:prose-lg break-words"
                  />
                </div>
              </div>
            ) : (
