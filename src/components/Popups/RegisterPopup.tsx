...
export default function RegisterPopup({setRegisterModal}){
    const closeModal = ()=>{
...
Lorem, ipsum dolor sit amet consectetur adipisicing elit. <br />
         ...
         <form className="mt-3 flex flex-col" >
             ...
             <input type="email" placeholder="Email" className="mt-2 placeholder-gray-700 ring-1 ring-black focus:ring-2 focus:outline-none px-1 py-1 rounded-sm" required />
             <input type="url" placeholder="Image Url" className="mt-2 placeholder-gray-700 ring-1 ring-black focus:ring-2 focus:outline-none px-1 py-1 rounded-sm" required />
            ...
            <div className="flex justify-end mt-3 items-center">
                ...
                <button type="submit" className="rounded-full bg-black  hover:bg-gray-800 cursor-pointer text-white px-2 py-1 ml-2">Register</button>
            </div>
         </form>
     </div>
     </div>
